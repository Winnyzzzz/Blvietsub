...
import { Loader2, Play, Calendar, Clock, Globe, Users, Film, AlertCircle } from "lucide-react";
...
export default function MovieDetail() {
  ...
  const renderPlayer = () => {
    if (!movie.iframeUrl && !movie.embedUrl) {
      return (
    ...
    return (
      <div className="w-full aspect-video rounded-2xl overflow-hidden bg-black shadow-[0_10px_50px_rgba(0,0,0,0.8)] border border-white/10 relative">
        <iframe
          src={movie.iframeUrl || movie.embedUrl}
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        {/* Background Blur Overlay using thumbnail */}
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
          
          {/* Player Section */}
          <div className="w-full max-w-6xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
            {renderPlayer()}
          </div>

          {/* Metadata Section */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            {/* Left: Poster & Actions (Desktop) */}
            <div className="hidden lg:block lg:col-span-3">
              <div className="sticky top-32 rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                <img 
                  src={getValidImageUrl(movie.thumbnail)} 
                  alt={movie.title} 
            ...
            <div className="col-span-1 lg:col-span-9 flex flex-col gap-8">
              <div>
                <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4 text-shadow">
                  {movie.title}
                </h1>
              ...
              <div className="prose prose-invert max-w-none">
                <h3 className="text-xl font-display font-semibold text-white flex items-center gap-2">
                  <Info className="w-5 h-5 text-primary" /> Nội dung phim
                </h3>
